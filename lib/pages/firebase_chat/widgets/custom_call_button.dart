...
import 'package:aero_meet/pages/firebase_chat/video_call/chat_room_screen/bloc/arrow_back_stack.dart';
...
class CustomBottomButton extends StatefulWidget {
  ...
  CustomBottomButton({this.profile,this.isVisibleButton = false});

  @override
  _CustomBottomButtonState createState() => _CustomBottomButtonState();
}

class _CustomBottomButtonState extends State<CustomBottomButton> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      mainAxisAlignment: widget.isVisibleButton ? MainAxisAlignment.spaceBetween:MainAxisAlignment.center,
